...
lista_a.remove(1)
ex_number = lista_a.pop(3)
lista_b.clear()

print("lista_a:", lista_a)
print("lista_b:", lista_b)
print("Numero sacado de lista_a", ex_number)
...
listado = [5, 2, 8, 1, 9, 4, 2]
print("Listado sin ordenar: ", listado)
listado.sort()


print("lista ordenada ascendente: ", listado)
print("Cuenta del numero 2: ", listado.count(2))
print("¿Existe el 7 en el listado? ", 7 in listado)
